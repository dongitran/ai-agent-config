...
function migrate(options = {}) {
  ...
  if (result.created) {
    if (!silent) {
      ...
      console.log("   • User config file in ~/.ai-agent/config.json");
      console.log("   • Add custom skill sources: ai-agent source add <repo>");
      console.log("   • Manage config: ai-agent config get/set");
      console.log("   • Export/import: ai-agent config export/import");
      console.log("\n📚 Run 'ai-agent --help' to see all new commands\n");
    }
