...
export const createItemTool = {
    name: 'create_item',
    description: 'Create a new item (login, secure note, card, or identity) in your vault',
    inputSchema: {
        type: 'object',
        properties: {
            name: {
...
export const editItemTool = {
    name: 'edit_item',
    description: 'Edit an existing item (login, secure note, card, or identity) in your vault',
    inputSchema: {
        type: 'object',
        properties: {
            id: {
...
export const confirmTool = {
    name: 'confirm',
    description: 'Confirm an invited organization member who has accepted their invitation',
    inputSchema: {
        type: 'object',
        properties: {
            organizationId: {
...
export const createOrgCollectionTool = {
...
export const editOrgCollectionTool = {
...
export const editItemCollectionsTool = {
...
export const moveTool = {
    name: 'move',
    description: 'Move (share) a vault item to an organization (formerly the share command)',
    inputSchema: {
        type: 'object',
        properties: {
            itemId: {
...
export const deviceApprovalListTool = {
...
export const deviceApprovalApproveTool = {
...
export const deviceApprovalApproveAllTool = {
...
export const deviceApprovalDenyTool = {
...
export const deviceApprovalDenyAllTool = {
...
export const createTextSendTool = {
...
export const createFileSendTool = {
...
export const removeSendPasswordTool = {
