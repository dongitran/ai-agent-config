...
export const listSchema = z
    ...
    if ((data.type === 'org-collections' || data.type === 'org-members') &&
        !data.organizationid) {
        return false;
    }
    return true;
}, {
    message: 'organizationid is required when listing org-collections or org-members',
});
...
export const getSchema = z
    ...
    message: 'organizationid is required for org-collection, itemid is required for attachment',
});
...
export const createItemSchema = z
    ...
    message: 'Type-specific data is required: login for type 1, secureNote for type 2, card for type 3, identity for type 4',
});
